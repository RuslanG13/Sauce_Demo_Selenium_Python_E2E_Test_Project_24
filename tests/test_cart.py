...
class TestCart:
    def test_add_item_through_catalog(self, browser, auth_positive, add_item_to_cart_through_catalog):
    ...
    def test_delete_item(self, browser, auth_positive, add_item_to_cart_through_catalog):
    ...
    def test_add_item_through_item_card(self, browser, auth_positive, add_item_to_cart_through_item_card):
    ...
    def test_delete_item_through_item_card(self, browser, auth_positive, add_item_to_cart_through_item_card):
