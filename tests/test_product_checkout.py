...
class TestProductCheckout:
    def test_product_checkout_with_valid_data(self, browser, auth_positive, add_item_to_cart_through_catalog):
        ...
        last_name_field = browser.find_element(*CheckPL.LAST_NAME_FIELD)
        ...
        complete_checkout_header_text = browser.find_element(*CheckPL.COMPLETE_HEADER).text
