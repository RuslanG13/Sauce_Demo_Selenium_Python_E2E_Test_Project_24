...
class TestFilter:
    def test_check_by_name_a_to_z(self, driver, auth_positive):
        ...
        driver.find_element(*IPL.DROPDOWN_PRODUCT_SORT_CONTAINER_BTN).click()
        driver.find_element(*IPL.SORT_A_Z_DROPDOWN_ITEM).click()

        item_names = driver.find_elements(*IPL.INVENTORY_ITEM_NAME)
    ...
    def test_check_by_name_z_to_a(self, driver, auth_positive):
        ...
        driver.find_element(*IPL.DROPDOWN_PRODUCT_SORT_CONTAINER_BTN).click()
        driver.find_element(*IPL.SORT_Z_A_DROPDOWN_ITEM).click()
    ...
    def test_check_by_price_low_to_high(self, driver, auth_positive):
        ...
        driver.find_element(*IPL.DROPDOWN_PRODUCT_SORT_CONTAINER_BTN).click()
        driver.find_element(*IPL.SORT_LOW_HIGH_DROPDOWN_ITEM).click()

        item_names = driver.find_elements(*IPL.INVENTORY_ITEMS_PRICE)
    ...
    def test_check_by_price_high_to_low(self, driver, auth_positive):
        ...
        driver.find_element(*IPL.DROPDOWN_PRODUCT_SORT_CONTAINER_BTN).click()
        driver.find_element(*IPL.SORT_HIGH_LOW_DROPDOWN_ITEM).click()
