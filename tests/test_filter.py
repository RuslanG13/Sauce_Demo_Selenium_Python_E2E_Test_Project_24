...
class TestFilter:
    def test_check_by_name_a_to_z(self, browser, auth_positive):
    ...
    def test_check_by_name_z_to_a(self, browser, auth_positive):
    ...
    def test_check_by_price_low_to_high(self, browser, auth_positive):
    ...
    def test_check_by_price_high_to_low(self, browser, auth_positive):
