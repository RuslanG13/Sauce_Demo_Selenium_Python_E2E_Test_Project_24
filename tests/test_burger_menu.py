...
def test_about_button(browser, auth_positive):
...
@pytest.mark.xfail
def test_reset_app_state_button(browser, auth_positive, add_item_to_cart_through_catalog, check_exist_item_in_cart):
